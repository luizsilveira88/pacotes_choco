...
# =====================================================
$fileType = 'exe' 
$expectedHash = "146706DEC8C09A0F57059466543C57E9FB1AF43F1273C622E248B858539A9B03"
$silentArgs = '-i silent'
...
# o instalador 2024 esta em openflow\openflow-2024.0.0.exe)
$installerName = "openflow-2024.0.0.exe"
$toolsDir     = Split-Path -Parent $MyInvocation.MyCommand.Definition
$networkPath  = "\\179.97.96.73\repositorio$\installers\openflow\$installerName"
